...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\DELL\Desktop\test\project\UnitTestInPython'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\DELL\Desktop\test\project\UnitTestInPython\Scripts\deactivate.nu'
